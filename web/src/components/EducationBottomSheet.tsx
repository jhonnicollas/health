...
export function EducationBottomSheet({ topicType, visible, onClose }: Props) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 200, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}
      ...
      <div style={{ background: 'var(--colorSurfaceElevated, #fff)', borderRadius: '16px 16px 0 0', width: '100%', maxWidth: 500, padding: 24, paddingBottom: 'max(24px, env(safe-area-inset-bottom, 0px))', maxHeight: '80vh', overflowY: 'auto' }}>
